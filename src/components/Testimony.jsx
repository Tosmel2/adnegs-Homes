  ...
  return (
    <div className='testimony_container'>
      <div className='testimony_content'>
        ...
        <svg width="50" height="40" viewBox="0 0 70 60" class="block absolute opacity-50" fill="none" xmlns="http://www.w3.org/2000/svg">
