  ...
  return (
    <div className='header'>
      ...
      <div className="header-content row">
        <h1 className='heading-text'>The Most Affordable Place To stay In The San Franciso Bay Area</h1>
        ...
        <div className='flex'>
          <select name="" id="">All Type</select>
          <select name="" id="">Neighborhood</select>
        </div>
        </div>
      </div>
    </div>
